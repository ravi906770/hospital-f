...
const Header = () => {
  ...
  return (
    <header className="header flex items-center bg-[url(./assets/images/mask.png)] bg-no-repeat bg-center bg-cover w-full h-[100px] leading-[100px]" ref={headerRef}>
      <div className="container  max-w-full w-[1440px] px-5 mx-auto">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/login">
              <button className="bg-primaryColor text-white py-2 px-6 font-[600] h-[44px] flex items-center justify-center
