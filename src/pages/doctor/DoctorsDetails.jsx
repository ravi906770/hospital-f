...
const DoctorsDetails = ()=>{
  ...
  <>
  <section>
    <div className="max-w-[1170px] px-5 mx-auto mt-[25px]">
      ...
      <div className="md:col-span-2">
        <div className="flex items-center gap-5">
          ...
          <div>
              ...
              <p className=" text-[14px] font-[400] text-textColor mt-[18px] leading-6 md:text-[15px] lg:max-w-[390px]">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aspernatur, magni?</p>
